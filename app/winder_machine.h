...
typedef void (*write_flash_fun_t)(machine_static_params_t * machine_static_params);
 ...
 */
void app_init(print_fun_t print_fun, step_fun_t x_step, step_fun_t y_step, get_us_fun_t get_us, motor_enable_fun_t motor_enable, write_flash_fun_t write_flash_fun, read_flash_fun_t read_flash_fun);
