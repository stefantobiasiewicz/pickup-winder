...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOA,
			LD2_Pin | Z_DIR_Pin | MOTOR_EN_Pin | X_STEP_Pin | GPIO_PIN_15,
			GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOC, LCD_D4_Pin | LCD_D1_Pin | LCD_D2_Pin | LCD_D3_Pin,
			GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, LCD_RS_Pin | LCD_E_Pin | X_DIR_Pin | Z_STEP_Pin,
			GPIO_PIN_RESET);
