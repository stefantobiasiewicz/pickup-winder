...
void motor_enable_fun(bool en){
	HAL_GPIO_WritePin(MOTOR_EN_GPIO_Port, MOTOR_EN_Pin, en == true ? GPIO_PIN_RESET : GPIO_PIN_SET);
}

void x_step_fun(bool dir) {
	HAL_GPIO_WritePin(X_DIR_GPIO_Port, X_DIR_Pin, dir == true ? GPIO_PIN_SET : GPIO_PIN_RESET);
...
void y_step_fun(bool dir) {
	HAL_GPIO_WritePin(Z_DIR_GPIO_Port, Z_DIR_Pin, dir == true ? GPIO_PIN_SET : GPIO_PIN_RESET);
