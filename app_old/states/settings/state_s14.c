...
//}
//
//state_node_t* state_s14_settings_xscrew(signal_t *signal) {
...
//
//
//const static state_node_t state_s14_settings_xscrew_state = {
//	.state_change_func = state_s14_change,
//	.state_func = state_s14_settings_xscrew,
//};
