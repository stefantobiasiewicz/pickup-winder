...
const state_node_t* state_s4_wire_thick_decision(signal_t *signal) {
...
state_node_t state_s4_wire_thick_decision_state;

void state_s4_init() {
	state_s4_wire_thick_decision_state.state_change_func = state_s4_change;
	state_s4_wire_thick_decision_state.state_func = state_s4_wire_thick_decision;
}
