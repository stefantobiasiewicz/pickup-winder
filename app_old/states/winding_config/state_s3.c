...
const state_node_t* state_s3_coil_turns_decision(signal_t *signal) {
...
//		break;
	case '\r':
		...
		break;
	case '/':
		result = &state_s2_cw_ccw_decision_state;
		break;
	default:
		break;
	}
...
state_node_t state_s3_coil_turns_decision_state;

void state_s3_init() {
	state_s3_coil_turns_decision_state.state_change_func = state_s3_change;
	state_s3_coil_turns_decision_state.state_func = state_s3_coil_turns_decision;
}
